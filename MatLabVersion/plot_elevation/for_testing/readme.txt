plot_elevation MATLAB Python Package
...
2. Installing the plot_elevation Package

A. Change to the directory that contains the file setup.py and the subdirectory 
plot_elevation. If you do not have write permissions, copy all its contents to a 
...
3. Using the plot_elevation Package

The plot_elevation package is on your Python path. To import it into a Python script or 
session, execute:
